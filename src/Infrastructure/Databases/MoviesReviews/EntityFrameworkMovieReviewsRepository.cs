...
using ApplicationReviewByStar = Application.Reviews.Entities.ReviewByStar;
...
internal class EntityFrameworkMovieReviewsRepository : IAuthorsRepository, IMoviesRepository, IReviewsRepository
{
    ...
    public async Task<List<ApplicationReviewByStar>> GetReviewByStar(int stars, CancellationToken cancellationToken)
    {
        var result = await this.context.Reviews
        ...
        return this.mapper.Map<List<ApplicationReviewByStar>>(result);
    }
